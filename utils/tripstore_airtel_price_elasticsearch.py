...
def airtel_elasticsearch():
    ...
    for i in range(0, lnth):
        ...
        url2 = 'https://api.tripstore.kr/guest/list/calendar?withGuide=false&cityId=1&placeId=' + str(
            cityId) + '&path=search'
        ...
        url3 = 'http://localhost:9200/airtel/class/'
        for j in range(0, lnth2):
            ...
            url5 = 'http://localhost:9200/not_busy_list_airtel/class'
